...
| `retro_adapter.py` | Ephemeris retro export → Exp2Res §19.1 JSONL payload; mapping and decisions in [retro-adapter.md](retro-adapter.md) ([#37](https://github.com/jointsome0-lgtm/selfos/issues/37)). |
